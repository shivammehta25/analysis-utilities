...
our_LJ_set = [
	...
	"Democracy will have failed far beyond the importance to it of any king of precedent concerning the judiciary.",
	...
	"Between the several sections were wide spaces where foot soldiers and cavalry might fight.",
	...
	"gaming of all sorts should be strictly forbidden under heavy pains and penalties.",
	"He had repeated this wish only a few days before, during his visit to Tampa, Florida.",
	"His disclaimer, distinct and detailed on every point, was intended simply for effect.",
	"I then stepped off of it and the officer picked it up in the middle and it bent so.",
	...
	"Oswald rose from his seat, bringing up both hands.",
	"But there were other notorious cases of forgery.",
	"Yet the law was seldom if ever enforced.",
