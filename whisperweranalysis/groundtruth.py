...
lj_valid = [
    ...
    "during the morning of November twenty-two prior to the motorcade.",
    ...
    "The Warren Commission Report. By The President's Commission on the Assassination of President Kennedy. Chapter seven. Lee Harvey Oswald:",
    ...
    "once you know that you must put the crosshairs on the target and that is all that is necessary.",
    ...
    "No night clubs or bowling alleys, no places of recreation except the trade union dances. I have had enough.",
    ...
    "drove to the northwest corner of Elm and Houston, and parked approximately ten feet from the traffic signal.",
